...
$(document).ready(function() {
    ...
    /**
     * This method will generate the css selector of the target
    ...
    b[0].addEventListener("click", function (event) {
        // get click location X and Y co-ordinates with respect to target element
        ...
        $.ajax({
            url:"http://localhost/collect.php?htid="+___htid+"&x="+clickEventX
                    +"&y="+clickEventY+"&selector="+eleSelector+"&url="+currentUrl,
            type:"GET"
        });
    },true);
